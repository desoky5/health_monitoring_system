...
void MDMA2_vSetStreamCfg(u8 A_u8StreamID,u32 *A_u32SourceAddr,u32 *A_u32DestAddr,Size_t A_xPSize,Size_t A_xMSize, u16 A_u16BlockSize,Threshold_t A_xThreshold);
