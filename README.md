...
|-|-|
|**Omar Desoky**|Heart Rate Monitoring module (sensor driver + alert/logging logic), Interactive UI (TFT/7-segment dashboard, settings, history), and the **web monitoring dashboard** (frontend + backend API)|
...
See [`docs/Health\_Monitor\_Requirements\_Analysis.pdf`](docs/Health_Monitor_Requirements_Analysis.pdf) for the full requirements analysis, including detailed functional/non-functional requirements and the project timeline.
